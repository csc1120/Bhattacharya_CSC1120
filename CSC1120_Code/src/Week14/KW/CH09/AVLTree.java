...
public class AVLTree<E extends Comparable<E>>
     ...
     *      from the left].
     * postThe balance is incremented and the increase flags is set to
     ...
     * from the AVL tree.
     * postThe object is not in the tree and removeReturn
     ...
     * prenode is not null
     * posta node is deleted from the tree
     ...
     * postThe found node is removed from the tree and replaced
     ...
     * postbalance is restored and increase and decrease
     ...
     * postbalance is restored and increase is set false
     * @param localRoot Root of the AVL subtree that needs rebalancing
     * @return a new localRoot
     */
    ...
    /*<exercise chapter="9" type="programming-project" number="1">*/
    // Solution to this programming project are the combination of
    // programming exercises at the end of section 2
    /*</exercise>*/
